            ...
            {isLanguageOpen && (
              <div className="absolute right-0 mt-2 w-32 bg-card border border-border rounded-lg shadow-lg z-10">
                <button
                  ...
                  className={`w-full text-left px-4 py-2 text-sm hover:bg-accent/10 transition-colors ${locale === "en" ? "bg-accent/5 text-accent" : ""}`}
                >
                  English
                </button>
                <button
                  onClick={() => handleLanguageChange("es")}
                  className={`w-full text-left px-4 py-2 text-sm hover:bg-accent/10 transition-colors ${locale === "es" ? "bg-accent/5 text-accent" : ""}`}
                >
                  Español
                </button>
              </div>
